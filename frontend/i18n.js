...
const I18N_DICT = {
  en: {
    ...
    "job.exportImagesTitle": "Embed the figures as real images in the markdown export",
    "job.exportImagesNone": "Images: none (placeholders)",
    "job.exportImagesZip": "Images: ZIP (md + images/)",
    "job.exportImagesBase64": "Images: base64 (single file)",
    "job.exportSplit": "Split by chapter (ZIP)",
    "job.exportSplitTitle": "One markdown file per chapter, packed as a ZIP",
    "job.exportReflow": "Reflowing…",
    "job.exportOutline": "LLM outline refinement…",
    "job.exportProgress": "LLM fix-up {done}/{total} blocks",
    "job.exportPhaseImages": "Extracting figures…",
    "job.exportPhaseZip": "Packaging…",
  ...
  zh: {
    ...
    "job.exportImagesTitle": "在 markdown 导出中嵌入真实图片",
    "job.exportImagesNone": "图片：不嵌入（占位符）",
    "job.exportImagesZip": "图片：ZIP 打包（md + images/）",
    "job.exportImagesBase64": "图片：base64 内嵌（单文件）",
    "job.exportSplit": "按章节拆分（ZIP）",
    "job.exportSplitTitle": "按章节拆成多个 markdown 文件，打包为 ZIP",
    "job.exportReflow": "重排中…",
    "job.exportOutline": "LLM 大纲校对…",
    "job.exportProgress": "LLM 校对 {done}/{total} 块",
    "job.exportPhaseImages": "提取图片…",
    "job.exportPhaseZip": "打包中…",
