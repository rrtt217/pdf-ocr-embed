...
const I18N_DICT = {
  en: {
    ...
    "job.exportMdTitle": "Download the recognized pages as markdown (instant, reflow only)",
    "job.exportTex": "⬇ LaTeX",
    "job.exportTexTitle": "Download the recognized pages as LaTeX (instant, reflow only)",
    "job.exportLlm": "⬇ Export +LLM",
    "job.exportLlmTitle": "Export markdown with the LLM block fix-up (tables / equations / low-conf) — streams progress, can take minutes",
  ...
  zh: {
    ...
    "job.exportMd": "⬇ Markdown",
    "job.exportMdTitle": "将识别结果导出为 markdown（即时，仅重排）",
    "job.exportTex": "⬇ LaTeX",
    "job.exportTexTitle": "将识别结果导出为 LaTeX（即时，仅重排）",
    "job.exportLlm": "⬇ 导出 +LLM",
    "job.exportLlmTitle": "导出 markdown 并用 LLM 修整难块（表格 / 公式 / 低置信）——有进度显示，可能需要几分钟",
